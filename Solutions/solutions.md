...
What is the average running time of films by category? 
 ...
 Find all the actors, whose last name contains the letters 'GEN'. Make this case insensitive. 
          ...
          where last_name like 'GEN' or last_name like 'gen';   
...
Perhaps we were too hasty in changing GROUCHO to HARPO. It turns out that GROUCHO was the correct name after all! In a single query, if the first name of the actor is currently HARPO, 
change it to GROUCHO. Otherwise, change the first name to MUCHO GROUCHO, as that is exactly what the actor will be with the grievous error. BE CAREFUL NOT TO CHANGE THE FIRST NAME OF EVERY ACTOR TO MUCHO GROUCHO(Hint: update the record using a unique identifier.)
